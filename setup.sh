...
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-arm64-ilp32.git;branch=master \
...
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cavium-octeontx-4.14.git;branch=master \
